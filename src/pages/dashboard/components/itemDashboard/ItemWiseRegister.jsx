...
export default function ItemWiseRegister({ columns, context, sortedItems, sortKey, handleSort, summary, fmtNumber, fmtINR }) {
  ...
  return (
    <section className="surface-card overflow-hidden">
      ...
      {filteredItems.length ? <RegisterPagination page={activePage} totalPages={totalPages} startIndex={startIndex} visibleCount={visibleItems.length} totalCount={filteredItems.length} itemLabel="items" onChange={setCurrentPage} scrollTargetId="item-register" placement="top" /> : null}
