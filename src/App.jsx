        ...
        <section className="relative overflow-hidden bg-gradient-to-b from-teal-50 via-[#f7faf9] to-[#f7faf9] px-4 pb-20 pt-16 sm:pb-12 sm:pt-24">
          ...
          <div className="relative z-10 mx-auto max-w-6xl text-center">
            ...
            <div className="mt-9 flex flex-col justify-center gap-3 sm:flex-row">
              <Link
                to="/register"
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-teal-700 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-teal-900/20 transition hover:bg-teal-800"
              >
                Start with Prana <ArrowRight size={16} />
              </Link>
              <Link
                to="/login"
                className="inline-flex items-center justify-center rounded-xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 shadow-sm transition hover:border-teal-300 hover:text-teal-800"
              >
          ...
          <div className="mx-auto max-w-6xl">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <h2 className="mt-3 text-3xl font-bold tracking-tight text-slate-950 sm:text-4xl">
                Less hunting for numbers. More room to move forward.
              </h2>
            </div>
